...
var outLang = "es";
var inLang = "en";
var prog = Math.min(parseInt(localStorage.progress, 10) + GAIN, 1000);
var rev = false;
console.log(prog);
...
function startLookup() {
    ...
    if (rev) {
        ...
        for (var z = 0; z < numSwaps; z++) {
            
            topPhraseArr[z] = sortedArr[sortedArr.length - 1 - z][0];
            finalPhraseArr[z] = encodeURI(sortedArr[sortedArr.length - 1 - z][0]);
